...
-- Show only movies with average rating above 4.5
...
-- Show top 10 most watched movies with their avg rating
...
-- Find movies rated above the overall average score where average score= 3.05356
...
-- Rank all movies by their average rating globally
...
-- Rank movies within each genre separately
...
-- Genre popularity report with ranking
...
-- Top 10 most active users with their rating behavior
...
-- Get movie statistics (avg rating + total ratings)
DELIMITER $$
